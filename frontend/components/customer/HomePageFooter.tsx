        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/privacy" className="hover:opacity-80 transition" style={{ color: '#728BBC' }}>
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link href="/terms" className="hover:opacity-80 transition" style={{ color: '#728BBC' }}>
                  Terms of Service
                </Link>
              </li>
              <li>
                <Link href="/contact" className="hover:opacity-80 transition" style={{ color: '#728BBC' }}>
                  Contact Us
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/shipping" className="hover:opacity-80 transition" style={{ color: '#728BBC' }}>
                  Shipping & Returns
                </Link>
              </li>
              <li>
                <Link href="/faq" className="hover:opacity-80 transition" style={{ color: '#728BBC' }}>
                  FAQ
                </Link>
              </li>
              <li>
                <Link href="/returns" className="hover:opacity-80 transition" style={{ color: '#728BBC' }}>
                  Easy Returns
                </Link>
              </li>
            </ul>
